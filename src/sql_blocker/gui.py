...
from src.sql_blocker.config import config, save_config
...
class BlockerMonitorApp:
    ...
    def test_connection_gui(self):
        ...
        if not conn_str:
            messagebox.showerror("Error", "Enter connection string")
            return

        from src.sql_blocker.utils.sql_utils import get_connection
